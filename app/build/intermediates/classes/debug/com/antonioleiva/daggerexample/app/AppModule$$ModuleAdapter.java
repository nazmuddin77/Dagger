...
public final class AppModule$$ModuleAdapter extends ModuleAdapter<AppModule> {
  private static final String[] INJECTS = { "members/com.antonioleiva.daggerexample.app.App", };
  private static final Class<?>[] STATIC_INJECTIONS = { };
  private static final Class<?>[] INCLUDES = { com.antonioleiva.daggerexample.app.domain.DomainModule.class, com.antonioleiva.daggerexample.app.interactors.InteractorsModule.class, };

  public AppModule$$ModuleAdapter() {
    super(com.antonioleiva.daggerexample.app.AppModule.class, INJECTS, STATIC_INJECTIONS, false /*overrides*/, INCLUDES, true /*complete*/, false /*library*/);
  }
  ...
  public static final class ProvideApplicationProvidesAdapter extends ProvidesBinding<android.app.Application>
    ...
    public ProvideApplicationProvidesAdapter(AppModule module) {
      super("android.app.Application", NOT_SINGLETON, "com.antonioleiva.daggerexample.app.AppModule", "provideApplication");
      this.module = module;
      setLibrary(false);
    }
